<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit.aspx.cs" Inherits="ThuVienNhac.edit" %>

<%@ Register Src="~/menuUC.ascx" TagPrefix="uc1" TagName="menuUC" %>
...
<uc1:menuUC runat="server" ID="menuUC" />
        <asp:FormView ID="FormViewEdit" runat="server" CellPadding="4" DataKeyNames="ma_baihat" DataSourceID="SqlDataedit" DefaultMode="Edit" ForeColor="#333333" OnItemCommand="FormViewEdit_ItemCommand" OnItemUpdated="FormViewEdit_ItemUpdated">
            <EditItemTemplate>
                ma_baihat:
        ...
        <asp:SqlDataSource ID="SqlDataedit" runat="server" ConnectionString="<%$ ConnectionStrings:QLNhacConnectionString %>" DeleteCommand="DELETE FROM [baihat] WHERE [ma_baihat] = @ma_baihat" InsertCommand="INSERT INTO [baihat] ([ma_baihat], [ten_baihat], [casi], [ma_theloai]) VALUES (@ma_baihat, @ten_baihat, @casi, @ma_theloai)" SelectCommand="SELECT * FROM [baihat] WHERE ([ma_baihat] = @ma_baihat)" UpdateCommand="UPDATE [baihat] SET [ten_baihat] = @ten_baihat, [casi] = @casi, [ma_theloai] = @ma_theloai WHERE [ma_baihat] = @ma_baihat">
            ...
            <SelectParameters>
                <asp:QueryStringParameter DefaultValue="-1" Name="ma_baihat" QueryStringField="id" Type="Int32" />
            </SelectParameters>
            <UpdateParameters>
                <asp:Parameter Name="ten_baihat" Type="String" />
                <asp:Parameter Name="casi" Type="String" />
